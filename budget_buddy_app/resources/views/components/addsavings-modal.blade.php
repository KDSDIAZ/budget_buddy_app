<div id="savingsModal" class="fixed z-10 inset-0 overflow-y-auto hidden">
                        <div class="flex items-center justify-center min-h-screen">
                            ...
                            <div class="flex justify-between items-center px-4 py-2 bg-gray-200 rounded-t">
                                <h3 class="text-lg font-medium">Add Goal</h3>
                            </div>
                            <div class="px-4 py-6">
                                 <form method="POST" action="{{ route('expenses.store') }}">
                                    ...
                                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                                            id="description" name="description" type="textarea" placeholder="Describe what this is for">
                                    </div>
